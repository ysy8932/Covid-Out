...
<div class="insert_member_container">
	<div class="insert_member_wrapper mform">
		<form action="savemember" method="post" id="signupform">
			...
			<h2 class="signup_main_title">구글 회원가입</h2>
			...
			<label class="signup_input">
				<input type="text" name="mnick" class="mnick" value="${gmdto.mnick}" required>
				<span class="signup_input_sp update"> <span class="glyphicon glyphicon-user"></span> Nick Name</span>
			</label>
			
			<label class="signup_input">
				<input type="text" name="memail" class="memail" value="${gmdto.memail}"  readonly required>
